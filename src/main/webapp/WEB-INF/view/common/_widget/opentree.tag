	...
	$(function(){
		$("#_${x.index!}_INPUT").bind("click",function(){
			...
			layer.open({
        	    ...
        	    fix: false, //不固定
        	    maxmin: true,
        	    content: "${ctxPath}/ztree/open/?type=${x.type!0}&index=_${x.index!0}&name="+encodeURI(encodeURI("${x.name!0}"))+"&source=${x.source!0}&check=${x.check!0}&where=${x.where!0}&intercept=${x.intercept!0}&ext=${x.ext!0}&treeId=${x.treeId!0}&val=" + val
