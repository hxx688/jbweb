...
public class PersonPartnerController extends BaseController {
	private static String CODE = "personPartner";
	private static String PREFIX = "dt_users";
	private static String LIST_SOURCE = "person.listPartner";
	...
	public String exportExcel(ModelMap map){
		...
		map.put(NormalExcelConstants.FILE_NAME,"合伙人信息");
        map.put(NormalExcelConstants.CLASS,Person.class);
        map.put(NormalExcelConstants.PARAMS,new ExportParams("合伙人列表", "导出人:"+userName,
                "合伙人信息"));
