 ...
 */
@Controller
@RequestMapping("/personStone")
public class PersonStoneController extends BaseController {
	private static String CODE = "personStone";
	private static String PREFIX = "dt_users";
	private static String LIST_SOURCE = "person.listStone";
	...
	public String exportExcel(ModelMap map){
		...
		map.put(NormalExcelConstants.FILE_NAME,"钻石合伙人信息");
        map.put(NormalExcelConstants.CLASS,Person.class);
        map.put(NormalExcelConstants.PARAMS,new ExportParams("钻石合伙人列表", "导出人:"+userName,
                "钻石合伙人信息"));
