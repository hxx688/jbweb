 ...
 */
@Controller
@RequestMapping("/personCity")
public class PersonCityController extends BaseController {
	private static String CODE = "personCity";
	private static String PREFIX = "dt_users";
	private static String LIST_SOURCE = "person.listCity";
	...
	public String exportExcel(ModelMap map){
		...
		map.put(NormalExcelConstants.FILE_NAME,"市级合伙人信息");
        map.put(NormalExcelConstants.CLASS,Person.class);
        map.put(NormalExcelConstants.PARAMS,new ExportParams("市级合伙人列表", "导出人:"+userName,
                "市级合伙人信息"));
