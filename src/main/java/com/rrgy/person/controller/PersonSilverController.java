 ...
 */
@Controller
@RequestMapping("/personSilver")
public class PersonSilverController extends BaseController {
	private static String CODE = "personSilver";
	private static String PREFIX = "dt_users";
	private static String LIST_SOURCE = "person.listSilver";
	...
	public String exportExcel(ModelMap map){
		...
		map.put(NormalExcelConstants.FILE_NAME,"银牌合伙人信息");
        map.put(NormalExcelConstants.CLASS,Person.class);
        map.put(NormalExcelConstants.PARAMS,new ExportParams("银牌合伙人列表", "导出人:"+userName,
                "银牌合伙人信息"));
