 ...
 */
@Controller
@RequestMapping("/personSalesApply")
public class personSalesApplyController extends BaseController {
	private static String CODE = "personSalesApply";
	private static String PREFIX = "dt_users";
	private static String LIST_SOURCE = "person.listSalesApply";
	...
	public String index(ModelMap mm) {
		mm.put("code", CODE);
		return BASE_PATH + "personSalesApply.html";
	}
