 ...
 */
@Controller
@RequestMapping("/personGoldApply")
public class personGoldApplyController extends BaseController {
	private static String CODE = "personGoldApply";
	private static String PREFIX = "dt_users";
	private static String LIST_SOURCE = "person.listGoldApply";
	...
	public String index(ModelMap mm) {
		mm.put("code", CODE);
		return BASE_PATH + "personGoldApply.html";
	}
