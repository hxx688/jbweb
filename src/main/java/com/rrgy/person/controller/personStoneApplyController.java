 ...
 */
@Controller
@RequestMapping("/personStoneApply")
public class personStoneApplyController extends BaseController {
	private static String CODE = "personStoneApply";
	private static String PREFIX = "dt_users";
	private static String LIST_SOURCE = "person.listStoneApply";
	...
	public String index(ModelMap mm) {
		mm.put("code", CODE);
		return BASE_PATH + "personStoneApply.html";
	}
