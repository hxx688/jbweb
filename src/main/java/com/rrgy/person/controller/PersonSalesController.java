 ...
 */
@Controller
@RequestMapping("/personSales")
public class PersonSalesController extends BaseController {
	private static String CODE = "personSales";
	private static String PREFIX = "dt_users";
	private static String LIST_SOURCE = "person.listSales";
	...
	public String index(ModelMap mm) {
		mm.put("code", CODE);
		return BASE_PATH + "personSales.html";
	}
	...
	public String view(@PathVariable String id, ModelMap mm) {
		PersonView.getPersonView(mm,service,id);
		mm.put("code", CODE);
		return BASE_PATH + "personSales_view.html";
	}
	...
	public String exportExcel(ModelMap map){
		...
		map.put(NormalExcelConstants.FILE_NAME,"商家信息");
        map.put(NormalExcelConstants.CLASS,Person.class);
        map.put(NormalExcelConstants.PARAMS,new ExportParams("商家列表", "导出人:"+userName,
                "商家信息"));
