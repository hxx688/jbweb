 ...
 */
@Controller
@RequestMapping("/personCityApply")
public class personCityApplyController extends BaseController {
	private static String CODE = "personCityApply";
	private static String PREFIX = "dt_users";
	private static String LIST_SOURCE = "person.listCityApply";
	...
	public String index(ModelMap mm) {
		mm.put("code", CODE);
		return BASE_PATH + "personCityApply.html";
	}
