 ...
 */
@Controller
@RequestMapping("/personProvinceApply")
public class personProvinceApplyController extends BaseController {
	private static String CODE = "personProvinceApply";
	private static String PREFIX = "dt_users";
	private static String LIST_SOURCE = "person.listProvinceApply";
	...
	public String index(ModelMap mm) {
		mm.put("code", CODE);
		return BASE_PATH + "personProvinceApply.html";
	}
