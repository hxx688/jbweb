 ...
 */
@Controller
@RequestMapping("/personPartnerApply")
public class PersonPartnerApplyController extends BaseController {
	private static String CODE = "personPartnerApply";
	private static String PREFIX = "dt_users";
	private static String LIST_SOURCE = "person.listPartnerApply";
	...
	public String index(ModelMap mm) {
		mm.put("code", CODE);
		return BASE_PATH + "personPartnerApply.html";
	}
