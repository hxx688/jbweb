 ...
 */
@Controller
@RequestMapping("/personGold")
public class PersonGoldController extends BaseController {
	private static String CODE = "personGold";
	private static String PREFIX = "dt_users";
	private static String LIST_SOURCE = "person.listGold";
	...
	public String exportExcel(ModelMap map){
		...
		map.put(NormalExcelConstants.FILE_NAME,"金牌合伙人信息");
        map.put(NormalExcelConstants.CLASS,Person.class);
        map.put(NormalExcelConstants.PARAMS,new ExportParams("金牌合伙人列表", "导出人:"+userName,
                "金牌合伙人信息"));
