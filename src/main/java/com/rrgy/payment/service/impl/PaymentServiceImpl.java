package com.rrgy.payment.service.impl;
...
import com.rrgy.payment.service.PaymentService;
...
public class PaymentServiceImpl extends BaseService<Payment> implements PaymentService{
	...
	public Map<String, Object> findOne(Object id) {
		return Md.selectUnique("payment.findOne", Paras.create().set("id", id), Map.class);
	}
