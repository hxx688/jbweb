...
public class GridManager {
	...
	public static Object paginate(Integer page, Integer rows, String source, String para) {
		return me.defaultGridFactory.paginate(null, page, rows, source, para, "", "", null, null);
	}
	
	public static Object paginate(Integer page, Integer rows, String source, String para,String sort, String order) {
		return me.defaultGridFactory.paginate(null, page, rows, source, para, sort, order, null, null);
	}
	
	public static Object paginate(Integer page, Integer rows, String source, String para,String sort, String order, IQuery intercept) {
		return me.defaultGridFactory.paginate(null, page, rows, source, para, sort, order, intercept, null);
	}
}
