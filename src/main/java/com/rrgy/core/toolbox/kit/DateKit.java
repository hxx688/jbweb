...
public class DateKit {
	...
	private final static SimpleDateFormat sdfMinute = new SimpleDateFormat("yyyy-MM-dd HH:mm");
	 ...
	 * @return
	 */
	public static boolean isBetweenDate(String date1, String date2, String sourDate, String dateFormat) {		
		Date curDate1 = new Date();
		Date curDate2 = new Date();
		Date curSourDate = new Date();
		try {
			SimpleDateFormat sdf = new SimpleDateFormat(dateFormat);
			curDate1 = sdf.parse(date1);
			curDate2 = sdf.parse(date2);
			if(curDate2.before(curDate1)){
				curDate2 = DateTimeKit.offsiteDay(curDate2, 1);
			}
			curSourDate = sdf.parse(sourDate);
			if ((curDate1.before(curSourDate) || curDate1.equals(curSourDate)) && (curDate2.after(curSourDate) || curDate2.equals(curSourDate)))
				return true;
			
			curDate2 = sdf.parse(date2);
			if(curDate2.before(curDate1)){
				curDate1 = DateTimeKit.offsiteDay(curDate1, -1);
			}
			if ((curDate1.before(curSourDate) || curDate1.equals(curSourDate)) && (curDate2.after(curSourDate) || curDate2.equals(curSourDate)))
				return true;
