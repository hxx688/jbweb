...
import com.rrgy.common.vo.TreeNode;
...
//			sb.append("    alert(\"该产品版权归 cbjr@163.com 所有，请勿盗版！\");");
//			sb.append("    return;");
//			sb.append("  }");
//			sb.append("  if(name == undefined){");
//			sb.append("    layer.alert(\"该产品版权归 cbjr@163.com 所有，请勿盗版！\", {icon: 2,title:\"侵权警告\"});");
//			sb.append("    return;");
//			sb.append("  } else if(!(name.indexOf(\"cbjr@163.com\") >= 0 && $supporter.is(\"span\") && !$supporter.is(\":hidden\"))){");
//			sb.append("    layer.alert(\"该产品版权归 cbjr@163.com 所有，请勿盗版！\", {icon: 2,title:\"侵权警告\"});");
//			sb.append("    return;");
//			sb.append("  }");
//			sb.append("  }, 1800);");
